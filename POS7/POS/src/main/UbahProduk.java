...
public class UbahProduk extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String KAPx = getKAP().substring(0, 1).toUpperCase() + getKAP().substring(1); 
        cbxKategoriProduk.setSelectedItem(KAPx);
        String SUPx = getSUP().substring(0, 1).toUpperCase() + getSUP().substring(1); 
        cbxSupplier.setSelectedItem(SUPx);
